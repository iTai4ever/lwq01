...
public class ActionProductDaoImpl implements ActionProductDao{
	...
	private String alias = "id,name,product_id as productId,"
			+"parts_id as partsId,icon_url as iconUrl,sub_images as subImages,detail,"
			+"spec_param as specParam,price,stock,status,is_hot as hot,created,updated";
	@Override
	...
	public Integer getTotalCount(ActionProduct product) {
		String sql = "select count(id) as nun from action_products where 1=1";
		List<Object>params = new ArrayList<>();
		...
		try {
			return queryRunner.query(sql, new ColumnListHandler<Long>("nun"), params.toArray()).get(0).intValue();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			return 0;
	...
	public List<ActionProduct> findProductNoPage(ActionProduct condition) {
		// TODO Auto-generated method stub
		String sql = "select "+alias+" from action_products where 1=1";
		List<Object> params  = new ArrayList<>();
	...
	public int insertProduct(ActionProduct product) {
		// TODO Auto-generated method stub
		String sql = "insert into action_products(id,name,product_id,parts_id,icon_url,"+
		             "sub_images,detail,spec_param,price,stock,status,is_hot,created,updated)"+
				     "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		Object[] params = {product.getId(),product.getName(),product.getProductId(),product.getPartsId(),product.getIconUrl(),
	...
	public List<ActionProduct> findProductsByPartsId(Integer partsId) {
		// TODO Auto-generated method stub
		String sql = "select "+alias+" from action_products where parts_id=? order by updated desc";
		try{
