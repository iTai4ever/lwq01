...
require(['jquery','bootstrap','datatables.net','bsdataTables','adminlte','common','param_update'],function(jquery,bootstrap,datatables,bsdataTables,adminlte,common,param_update){
    $(function(){
        //用户校验
